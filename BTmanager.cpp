...
BTmanagerResult BTmanager::checkConnection() {
    ...
    if (bt_module_connected == bt_module_connected_now) return bt_module_connected ? BTmoduleOn : BTmoduleOff;
...
BTmanagerResult BTmanager::checkPresence() {
    ...
    if (  bt_module_present == bt_module_present_now) return BTmoduleOn; //Nothing to do
